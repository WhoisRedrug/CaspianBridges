...
// Universitet məlumatları - undefined xətası verə biləcək bütün açarlar (key) dəqiqləşdirildi
$universities = [
    [
    ...
    [
        ...
        'detail' => [
            'az' => 'ADA Universiteti 2006-cı ildə Azərbaycan Respublikasının Xarici İşlər Nazirliyi nəzdində yaradılmış və daha sonra ali təhsil müəssisəsi kimi fəaliyyətini genişləndirmişdir. Şəhərcik modeli əsasında qurulan ADA Qərb ali təhsil standartlarını, şəffaflığı və tədqiqat yönümlü mühiti təşviq edir. Universitetdə İnformasiya Texnologiyaları və Mühəndislik, Biznes və İdarəetmə, İctimai və Beynəlxalq Münasibətlər fakültələri mövcuddur. Tədris tamamilə ingilis dilində aparılır və dünyanın qabaqcıl universitetləri ilə ikili diplom proqramları mövcuddur.',
            'en' => 'ADA University was established in 2006 under the Ministry of Foreign Affairs of the Republic of Azerbaijan and later expanded as a full higher education institution. Built on a smart-campus model, ADA promotes Western academic standards, transparency, and a research-oriented environment. It houses faculties of IT and Engineering, Business, and Public and International Affairs, offering fully English-taught programs and prestigious dual-degree partnerships with top global universities.',
            'ru' => 'Университет ADA был создан в 2006 году при Министерстве иностранных дел Азербайджанской Республики. Кампус университета спроектирован по американским стандартам и предлагает передовые программы в области IT, инженерии, бизнеса и международных отношений на английском языке, а также программы двойных дипломов с ведущими вузами мира.',
            'ar' => 'تأسست جامعة ADA في عام 2006 تحت إشراف وزارة الخارجية في جمهورية أذربيجان. تعتمد على معايير التعليم الغربية والبيئة الموجهة للبحث العلمي. تضم كليات تكنولوجيا المعلومات والهندسة، الأعمال، الشؤون العامة والدولية، مع برامج أكاديمية باللغة الإنجليزية بالكامل.'
        ]
    ],
    [
    ...
    [
        ...
        'level' => [
            'az' => 'Bakalavr • Rezidentura • Magistr',
            'en' => 'Bachelor • Residency • Master',
            'ru' => 'Бакалавриат • Резидентура • Магистратура',
            'ar' => 'بكالوريوس • إقامة طبية • ماجستير'
        ],
        'short' => [
    ...
    [
        ...
        'detail' => [
            'az' => 'Azərbaycan Dövlət İqtisad Universiteti (UNEC) Cənubi Qafqazın iqtisadi yönümlü ən büyük ali təhsil müəssisəsidir. UNEC-də maliyyə, mühasibat uçotu, beynəlxalq ticarət, rəqəmsal iqtisadiyyat və biznesin idarə edilməsi (MBA) proqramları yüksək səviyyədə tədris olunur. Universitet dilli təhsil sistemi (azərbaycan, rus, ingilis, türk dilləri) və London Universiteti / LSE ilə olan akademik əməkdaşlıqları ilə seçilir.',
    ...
    [
        ...
        'detail' => [
            'az' => 'Sumqayıt Dövlət Universiteti (SDU) ölkənin iri sənaye mərkəzi olan Sumqayıt şəhərində yerləşən aparıcı dövlət universitetidir. Universitet kimya mühəndisliyi, texnologiya, energetika, fizika, riyaziyyat və filologiya istiqamətlərində mütəxəssislər hazırlayır. SDU sənaye müəssisələri ilə sıx əməkdaşlıq edərək tələbələrə real istehsalat mühitində təcrübə qazanmaq imkanı yaradır.',
            'en' => 'Sumgayit State University (SDU) is a prominent public university located in the major industrial hub of Sumgayit, near Baku. It trains specialists in chemical engineering, technology, power engineering, physics, mathematics, and philology. SDU maintains close partnerships with industrial enterprises, offering students practical training opportunities in real industrial environments.',
...
<body class="bg-[#061412] text-slate-100 antialiased selection:bg-emerald-400 selection:text-slate-950">
                    ...
                    <div>
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex items-center gap-2 mb-3">
                                ...
                                <span class="text-[11px] font-medium text-amber-300/90"><?php echo htmlspecialchars($u['level']['az']); ?></span>
                            </div>
                            <p class="text-slate-400 text-xs leading-relaxed mb-4"><?php echo htmlspecialchars($u['short']['az']); ?></p>
                    ...
                    <div>
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex items-center gap-2 mb-3">
                                <span class="text-[11px] font-bold text-emerald-400 uppercase tracking-wide">📍 <?php echo htmlspecialchars($u['city']); ?></span>
                                <span class="text-slate-600">•</span>
                                <span class="text-[11px] font-medium text-amber-300/90"><?php echo htmlspecialchars($u['level']['en']); ?></span>
                            </div>
                            <p class="text-slate-400 text-xs leading-relaxed mb-4"><?php echo htmlspecialchars($u['short']['en']); ?></p>
                    ...
                    <div>
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex items-center gap-2 mb-3">
                                <span class="text-[11px] font-bold text-emerald-400 uppercase tracking-wide">📍 <?php echo htmlspecialchars($u['city']); ?></span>
                                <span class="text-slate-600">•</span>
                                <span class="text-[11px] font-medium text-amber-300/90"><?php echo htmlspecialchars($u['level']['ru']); ?></span>
                            </div>
                            <p class="text-slate-400 text-xs leading-relaxed mb-4"><?php echo htmlspecialchars($u['short']['ru']); ?></p>
                    ...
                    <div>
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex items-center justify-end gap-2 mb-3">
                                <span class="text-[11px] font-medium text-amber-300/90"><?php echo htmlspecialchars($u['level']['ar']); ?></span>
                                <span class="text-slate-600">•</span>
                                <span class="text-[11px] font-bold text-emerald-400 uppercase tracking-wide"><?php echo htmlspecialchars($u['city']); ?> 📍</span>
                            </div>
                            <p class="text-slate-400 text-xs leading-relaxed mb-4"><?php echo htmlspecialchars($u['short']['ar']); ?></p>
    ...
    <script>
        ...
        function openUniversityModal(index, lang) {
            ...
            // Dildən asılı olaraq səviyyə və detail mətnlərini 'undefined' xətası verməyəcək şəkildə təyin edirik
            if (lang === 'en') {
                document.getElementById('modalLevel').innerText = uni.level.en;
                document.getElementById('modalDescription').innerText = uni.detail.en;
            } else if (lang === 'ru') {
                document.getElementById('modalLevel').innerText = uni.level.ru;
                document.getElementById('modalDescription').innerText = uni.detail.ru;
            } else if (lang === 'ar') {
                document.getElementById('modalLevel').innerText = uni.level.ar;
                document.getElementById('modalDescription').innerText = uni.detail.ar;
                document.getElementById('modalContentBox').setAttribute('dir', 'rtl');
            } else {
                document.getElementById('modalLevel').innerText = uni.level.az;
                document.getElementById('modalDescription').innerText = uni.detail.az;
