...
<body class="bg-[#061412] text-slate-100 antialiased selection:bg-emerald-400 selection:text-slate-950 min-h-screen">
    ...
    <div data-lang="az">
        <section class="hero-bg pt-32 pb-20 px-6 min-h-screen flex items-center justify-center relative overflow-hidden">
            ...
            <div class="w-full max-w-2xl glass-card p-8 sm:p-10 rounded-3xl shadow-2xl relative z-10 border border-slate-800 text-left">
                ...
                <form method="POST" class="space-y-5">
                    ...
                    <div class="grid sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="firstname" placeholder="John" required class="w-full bg-[#061412] border border-slate-800 rounded-xl px-4 py-3 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-emerald-500 transition">
                        </div>
                        <div>
                            <label class="text-xs font-bold text-slate-300 uppercase block mb-1.5">Last Name</label>
                            <input type="text" name="lastname" placeholder="Doe" required class="w-full bg-[#061412] border border-slate-800 rounded-xl px-4 py-3 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-emerald-500 transition">
                        </div>
                    </div>
                    <div class="grid sm:grid-cols-2 gap-4">
                        <div>
                            <label class="text-xs font-bold text-slate-300 uppercase block mb-1.5">Email Address</label>
                            <input type="email" name="email" placeholder="john@example.com" required class="w-full bg-[#061412] border border-slate-800 rounded-xl px-4 py-3 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-emerald-500 transition">
                        </div>
                        <div>
                            <label class="text-xs font-bold text-slate-300 uppercase block mb-1.5">Phone / WhatsApp</label>
                            <input type="tel" name="phone" placeholder="+1 (555) 000-0000" required class="w-full bg-[#061412] border border-slate-800 rounded-xl px-4 py-3 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-emerald-500 transition">
                        </div>
                    </div>
                    <div>
    ...
    <div data-lang="ru" class="hidden">
        <section class="hero-bg pt-32 pb-20 px-6 min-h-screen flex items-center justify-center relative overflow-hidden">
            ...
            <div class="w-full max-w-2xl glass-card p-8 sm:p-10 rounded-3xl shadow-2xl relative z-10 border border-slate-800 text-left">
                <div class="text-center mb-8">
                    <span class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 text-xs font-bold mb-3"> ⚡ Быстрая и безопасная заявка </span>
                    ...
                    <p class="text-slate-400 text-xs sm:text-sm mt-2"> Пожалуйста, заполните форму ниже. Наши специалисты рассмотрят ваши данные в течение 24 часов. </p>
                </div>
                <form method="POST" class="space-y-5">
                    <input type="hidden" name="action" value="apply">
                    <?php echo csrf_field(); ?>
                    <div class="grid sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="firstname" placeholder="Иван" required class="w-full bg-[#061412] border border-slate-800 rounded-xl px-4 py-3 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-emerald-500 transition">
                        </div>
                        <div>
                            <label class="text-xs font-bold text-slate-300 uppercase block mb-1.5">Фамилия</label>
                            <input type="text" name="lastname" placeholder="Иванов" required class="w-full bg-[#061412] border border-slate-800 rounded-xl px-4 py-3 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-emerald-500 transition">
                        </div>
                    </div>
                    <div class="grid sm:grid-cols-2 gap-4">
                        <div>
                            <label class="text-xs font-bold text-slate-300 uppercase block mb-1.5">Электронная почта</label>
                            <input type="email" name="email" placeholder="ivan@example.com" required class="w-full bg-[#061412] border border-slate-800 rounded-xl px-4 py-3 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-emerald-500 transition">
                        </div>
                        <div>
                            <label class="text-xs font-bold text-slate-300 uppercase block mb-1.5">Телефон / WhatsApp</label>
                            <input type="tel" name="phone" placeholder="+7 (999) 000-00-00" required class="w-full bg-[#061412] border border-slate-800 rounded-xl px-4 py-3 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-emerald-500 transition">
                        </div>
                    </div>
                    <div>
                        <label class="text-xs font-bold text-slate-300 uppercase block mb-1.5">Целевая услуга</label>
                        <select name="service" class="w-full bg-[#061412] border border-slate-800 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-emerald-500 transition">
                            <option value="Visa Services">🛂 Визовые услуги (Visa)</option>
                            <option value="Education">🎓 Образование (Education)</option>
                            <option value="Investment">📈 Инвестиции (Invest)</option>
                            <option value="Travel">✈️ Туризм (Travel)</option>
                        </select>
                    </div>
                    <div>
    ...
    <div data-lang="ar" class="hidden">
        <section class="hero-bg pt-32 pb-20 px-6 min-h-screen flex items-center justify-center relative overflow-hidden">
            <div class="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-emerald-500/10 rounded-full blur-[140px] pointer-events-none"></div>
            <div class="w-full max-w-2xl glass-card p-8 sm:p-10 rounded-3xl shadow-2xl relative z-10 border border-slate-800 text-right">
                <div class="text-center mb-8">
                    ...
                    <p class="text-slate-400 text-xs sm:text-sm mt-2"> يرجى تعبئة النموذج أدناه. سيقوم متخصصونا بمراجعة تفاصيلك في غضون 24 ساعة. </p>
                </div>
                <form method="POST" class="space-y-5">
                    <input type="hidden" name="action" value="apply">
                    <?php echo csrf_field(); ?>
                    <div class="grid sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="firstname" placeholder="محمد" required class="w-full bg-[#061412] border border-slate-800 rounded-xl px-4 py-3 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-emerald-500 transition text-right">
                        </div>
                        <div>
                            <label class="text-xs font-bold text-slate-300 uppercase block mb-1.5">اسم العائلة</label>
                            <input type="text" name="lastname" placeholder="الأحمد" required class="w-full bg-[#061412] border border-slate-800 rounded-xl px-4 py-3 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-emerald-500 transition text-right">
                        </div>
                    </div>
                    <div class="grid sm:grid-cols-2 gap-4">
                        <div>
                            <label class="text-xs font-bold text-slate-300 uppercase block mb-1.5">البريد الإلكتروني</label>
                            <input type="email" name="email" placeholder="mohammed@example.com" required class="w-full bg-[#061412] border border-slate-800 rounded-xl px-4 py-3 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-emerald-500 transition text-right">
                        </div>
                        <div>
                            <label class="text-xs font-bold text-slate-300 uppercase block mb-1.5">الهاتف / واتساب</label>
                            <input type="tel" name="phone" placeholder="+966 50 000 0000" required class="w-full bg-[#061412] border border-slate-800 rounded-xl px-4 py-3 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-emerald-500 transition text-right">
                        </div>
                    </div>
                    <div>
                        ...
                        <select name="service" class="w-full bg-[#061412] border border-slate-800 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-emerald-500 transition text-right">
                            <option value="Visa Services">🛂 خدمات التأشيرات (Visa)</option>
                            <option value="Education">🎓 التعليم (Education)</option>
                            <option value="Investment">📈 الاستثمار (Invest)</option>
                            <option value="Travel">✈️ السياحة (Travel)</option>
                        </select>
                    </div>
                    <div>
        ...
        form.addEventListener('submit', function(e) {
            ...
            .then(data => {
                if (data.trim() === 'success') {
                    ...
                    const loginTexts = {
                        'az': { title: 'Giriş Tələb Olunur', desc: 'Müraciət göndərmək və statusunu izləmək üçün əvvəlcə sistemə daxil olmalısınız.', btn: 'Daxil Ol', retry: 'Yenidən cəhd et' },
                        'en': { title: 'Login Required', desc: 'You must log in first to submit an application and track its status.', btn: 'Sign In', retry: 'Try Again' },
                        'ru': { title: 'Требуется вход', desc: 'Вы должны войти в систему, чтобы подать заявку и отслеживать ее статус.', btn: 'Войти', retry: 'Повторить' },
                        'ar': { title: 'تسجيل الدخول مطلوب', desc: 'يجب عليك تسجيل الدخول أولاً لتقديم طلب وتتبعه.', btn: 'تسجيل الدخول', retry: 'حاول مرة أخرى' }
                    };
                    ...
                    const errorTexts = {
                        ...
                        'ru': { title: 'Произошла ошибка', desc: 'Пожалуйста, обновите страницу и попробуйте снова.', btn: 'Обновить' },
                        'ar': { title: 'حدث خطأ', desc: 'يرجى تحديث الصفحة والمحاولة مرة أخرى.', btn: 'تحديث' }
                    };
